...
|---|---:|---:|---|
| Excel (.xlsx/.xlsm) | 40 | 339 worksheets (273 visible, 66 hidden) | 40 read, 0 errors |
| PDF | 38 | 668 pages / 655,569 extracted characters | 38 read, 0 errors |
...
The Excel pass visited approximately 1,024,117 non-empty cells and 386,046 formula cells. It observed 45,535 cached formula-error values; most are concentrated in Life Planning simulation/template ranges and require Excel recalculation with controlled test scenarios before being classified as defects.
...
|---|---:|---:|---|
| (ตาราง ง.) เอกสารประกอบการขายกรมธรรม์ Life Verse 99-99.pdf | 3 | 4,453 | read |
...
- Audit JSON and parser runtime remain under ignored `tmp/downloads-memory-audit` and are not intended for source control.
